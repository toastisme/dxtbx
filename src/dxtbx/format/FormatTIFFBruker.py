...
class FormatTIFFBruker(FormatTIFF):
    ...
    def _detector(self):
        ...
        distance = self._get_bruker_distance()
        beam_x, beam_y = self._get_bruker_beam_xy()
        pixel_size = self._get_bruker_pixel_size()
    ...
    def _get_bruker_pixel_size(self):
