...
TExperimentModel = TypeVar(
    "TExperimentModel", BeamBase, Detector, Goniometer, ScanBase, CrystalBase, object
)
...
class TOFSequence(ScanBase):
    ...
    def get_tof(self) -> flex.double: ...
    def get_wavelengths(self) -> flex.double: ...
    def get_num_tof_bins(self) -> int: ...
    def get_tof_range(self) -> Vec2Float: ...
    def get_image_tof(self) -> float: ...
    def get_image_wavelength(self) -> float: ...
    def set_tof_wavelengths(
        self, tof: flex.double, wavelengths: flex.double
    ) -> None: ...
    def swap(self, other: TOFSequence) -> None: ...
    def to_dict(self) -> Dict: ...
    def append(self, other: TOFSequence) -> None: ...
    @staticmethod
    def from_dict(data: Dict) -> TOFSequence: ...
    def __getitem__(self, index: Union[int, slice]) -> TOFSequence: ...
    def __len__(self) -> int: ...
    def __add__(self, other: TOFSequence) -> TOFSequence: ...
    def __iadd__(self, other: TOFSequence) -> TOFSequence: ...
    def __ge__(self, other: TOFSequence) -> bool: ...
    def __gt__(self, other: TOFSequence) -> bool: ...
    def __le__(self, other: TOFSequence) -> bool: ...
    def __lt__(self, other: TOFSequence) -> bool: ...
